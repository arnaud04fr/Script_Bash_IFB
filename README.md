...
**TruSeq3-SE.fa** : fichier nécessaire pour filtrage des séquences d'adaptatrices avec trimmomatic ([source: Trimmomatic](https://github.com/timflutre/trimmomatic/tree/master/adapters))
